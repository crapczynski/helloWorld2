...
with app.app_context():
    ...
    users = [
        ...
        {
            'username': 'Crapczyn',
            'email': 'crapczyn@terpmail.umd.edu',
            'first_name': 'Cole',
            'last_name': 'Rapczynski',
            'password': generate_password_hash('Crapczyn', method='pbkdf2:sha256'),
            'role': 'STUDENT'
        }
    ]
    ...
    students = [
            ...
            'major_id': 3, 'birth_date': dt.strptime('2007-08-01', '%Y-%m-%d'), 'is_honors': 1},
        {
            ...
            'email': 'crapczyn@terpmail.umd.edu',
            'major_id': 3,
            'birth_date': dt.strptime('2002-01-01', '%Y-%m-%d'),
            'is_honors': 1
        }
    ]
